...
select id, name from students where name like '_%8';
...
--проверка, что в таких пользователях нет такого пароля
select name, created_on, password from students where created_on = '2021-07-12 00:00:00';
...
select name, created_on from students where created_on = '2021-08-08 00:00:00' and name like '%8%';
...
select name, id from students where id = 53;
-- 19. Вывести пользователя у которых id больше 40
select name, id from students where id > 40;
-- 20. Вывести пользователя у которых id меньше 30
select name, id from students where id < 30;
--21. Вывести пользователя у которых id меньше 27 или больше 88
select name, id from students where id < 27 or id > 88;
--22. Вывести пользователя у которых id меньше либо равно 37
select name, id from students where id <= 37;
